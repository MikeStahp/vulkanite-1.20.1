...
public class EntityCapture {
    ...
    private static class VertexCaptureProvider implements VertexConsumerProvider {
        ...
        public VertexConsumer getBuffer(RenderLayer layer) {
            // Replaced Map.compute with explicit get/put to avoid capturing lambda allocation per frame
        ...
        public List<Pair<RenderLayer, BufferBuilder.BuiltBuffer>> end() {
            ...
            // Replaced Map.forEach with explicit loop to avoid per-frame lambda allocation overhead
