...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // Bolt ⚡: Optimization - Replacing streams with explicit loops to avoid per-frame GC allocations
        ...
        // Bolt ⚡: Optimization - Pre-allocating list and using explicit loop to avoid stream allocations
