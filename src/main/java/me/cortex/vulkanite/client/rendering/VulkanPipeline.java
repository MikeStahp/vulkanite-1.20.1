...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // Bolt ⚡ Optimization: Replaced Stream APIs with arrays and loops to prevent GC allocations
        ...
        // Bolt ⚡ Optimization: Pre-sized ArrayList to eliminate List reallocation overhead
