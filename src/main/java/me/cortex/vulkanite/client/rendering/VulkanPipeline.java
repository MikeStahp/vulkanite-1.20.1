...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // ⚡ Bolt: Replaced stream operations with pre-allocated arrays and loops to reduce GC overhead in the rendering hot path
        ...
        // ⚡ Bolt: Replaced stream mapping with a pre-sized ArrayList and a traditional loop
