...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // ⚡ Bolt: Replaced stream operations with a simple loop to avoid per-frame allocations and GC overhead
        ...
        // ⚡ Bolt: Replaced streams with simple allocation to reduce overhead
        var outImgs = new java.util.ArrayList<VRef<VImage>>(size);
        for (var img : vgOutImgs) {
