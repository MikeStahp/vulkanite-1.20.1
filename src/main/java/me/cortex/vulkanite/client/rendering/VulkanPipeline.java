...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // ⚡ Bolt: Eliminate slow Stream allocations by replacing with basic loops to reduce GC pressure on the render thread
        ...
        // ⚡ Bolt: Eliminate slow Stream allocations for mapping outImgs
