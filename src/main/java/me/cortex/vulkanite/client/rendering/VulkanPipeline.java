...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // Optimization: Use explicit arrays and a loop instead of Streams
        ...
        // Optimization: Use a pre-sized ArrayList and an explicit loop instead of Streams
        // to avoid per-frame GC allocations and stream overhead in this hot path.
