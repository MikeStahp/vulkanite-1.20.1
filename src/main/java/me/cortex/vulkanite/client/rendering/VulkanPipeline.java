...
public class VulkanPipeline {
    ...
    public void renderPostShadows(List<VRef<VGImage>> vgOutImgs, Camera camera, ShaderStorageBuffer[] ssbos,
        ...
        // Use explicit arrays/loops instead of Streams to avoid per-frame GC allocations and unboxing overhead
        ...
        // Use explicit lists instead of Streams to avoid per-frame GC allocations
