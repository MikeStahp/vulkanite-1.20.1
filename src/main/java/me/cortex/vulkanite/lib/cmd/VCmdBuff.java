...
public class VCmdBuff extends VObject {
    ...
    public void bindDSet(VRef<VDescriptorSet>... sets) {
        // Performance optimization: Avoid Arrays.stream(...) in hot path to prevent GC pressure
    ...
    public void bindDSet(List<VRef<VDescriptorSet>> sets) {
        // Performance optimization: Avoid list.stream() in hot path to prevent per-frame allocations
        int size = sets.size();
