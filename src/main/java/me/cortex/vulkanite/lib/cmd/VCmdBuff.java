...
public class VCmdBuff extends VObject {
    ...
    public void bindDSet(VRef<VDescriptorSet>... sets) {
        // Bolt optimization: Replace stream usage with standard array sizing and loops
        // to mitigate stream creation and lambdas in tight loop bindings.
