...
public class AllocationHelper extends BaseAllocationHelper {

    public AllocationHelper(VkDevice device, long allocator, boolean hasDeviceAddresses) {
    ...
    public BufferAllocation alloc(long pool, VkBufferCreateInfo bufferCreateInfo, VmaAllocationCreateInfo allocationCreateInfo, long alignment) {
        return allocBuffer(pool, bufferCreateInfo, allocationCreateInfo, alignment);
    }

    // Convenience method to maintain backward compatibility
    public ImageAllocation alloc(long pool, VkImageCreateInfo imageCreateInfo, VmaAllocationCreateInfo allocationCreateInfo) {
        return allocImage(pool, imageCreateInfo, allocationCreateInfo);
    }
}